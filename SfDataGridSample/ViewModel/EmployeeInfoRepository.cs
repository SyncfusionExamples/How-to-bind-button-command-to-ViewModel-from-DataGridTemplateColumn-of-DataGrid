...
namespace SfDataGridSample
{
    ...
    {
        public ICommand DeleteRecordCommand { private set; get; }

        public EmployeeViewModel()
        {
            PopulateData();
            employees = this.GetEmployeeDetails(200);
            DeleteRecordCommand = new Command(DeleteCommand);

        }

        public void DeleteCommand(object record)
        {
            Employees.Remove(record as Employee);
        }
